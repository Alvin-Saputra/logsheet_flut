...
FormTransferHeaderModel _$FormTransferHeaderModelFromJson(
  ...
  jsonCheckedBy: json['checked_by'] as String?,
  jsonCheckedDate: json['checked_date'] as String?,
  jsonCheckedStatus: json['checked_status'] as String?,
  jsonCheckedStatusRemarks: json['checked_status_remarks'] as String?,
  ...
  jsonAcknowledgedBy: json['acknowledged_by'] as String?,
  jsonAcknowledgedDate: json['acknowledged_date'] as String?,
  jsonAcknowledgedStatus: json['acknowledged_status'] as String?,
  jsonAcknowledgedStatusRemarks: json['acknowledged_status_remarks'] as String?,
...
Map<String, dynamic> _$FormTransferHeaderModelToJson(
  ...
  'checked_by': instance.jsonCheckedBy,
  'checked_date': instance.jsonCheckedDate,
  'checked_status': instance.jsonCheckedStatus,
  'checked_status_remarks': instance.jsonCheckedStatusRemarks,
  ...
  'acknowledged_by': instance.jsonAcknowledgedBy,
  'acknowledged_date': instance.jsonAcknowledgedDate,
  'acknowledged_status': instance.jsonAcknowledgedStatus,
  'acknowledged_status_remarks': instance.jsonAcknowledgedStatusRemarks,
