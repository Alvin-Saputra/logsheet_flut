...
class AnalyticalResultIncomingMaterialByTruckProvider with ChangeNotifier {
  final AnalyticalResultIncomingMaterialByTruckApiService _apiService;
  ...
  Future<bool> insertReport({
    ...
    try {
      final body = {
        ...
        "ss_others": headerInput.ssOthers,
        "detail":
            headerInput.details
                .map(
                  (detail) => {
