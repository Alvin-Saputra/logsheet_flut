...
class AnalyticalResultIncomingMaterialByVesselListPage extends StatefulWidget {
  const AnalyticalResultIncomingMaterialByVesselListPage({super.key});

  @override
  State<AnalyticalResultIncomingMaterialByVesselListPage> createState() =>
      _AnalyticalResultIncomingMaterialByVesselListPageState();
}

class _AnalyticalResultIncomingMaterialByVesselListPageState
    extends State<AnalyticalResultIncomingMaterialByVesselListPage> {
