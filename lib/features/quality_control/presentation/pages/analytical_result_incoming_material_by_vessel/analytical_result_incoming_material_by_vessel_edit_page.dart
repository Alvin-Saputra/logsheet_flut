  ...
  initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) async {
      ...
      setState(() {
        ...
        shipNameController.text = widget.data.shipName ?? '';
        ...
        othersController.text = widget.data.others ?? '';
        hasilAnalisaFfaController.text =
            widget.data.hasilAnalisaFfa?.toString() ?? '';
        hasilAnalisaIvController.text =
        ...
        hasilAnalisaPvController.text =
            widget.data.hasilAnalisaPv?.toString() ?? '';
        hasilAnalisaAnvController.text =
            widget.data.hasilAnalisaAnv?.toString() ?? '';
        hasilAnalisaTotoxController.text =
            widget.data.hasilAnalisaTotox?.toString() ?? '';
        hasilAnalisaCarotexController.text =
        ...
        for (int i = 0; i < widget.data.details.length; i++) {
          final detail = widget.data.details[i];
          // detailControllers[i]['palka_s_no']!.text = detail.palkaSNo ?? '';
          detailControllers[i]['palka_s_ffa']!.text =
              detail.palkaSFfa?.toString() ?? '';
          detailControllers[i]['palka_s_iv']!.text =
              detail.palkaSIv?.toString() ?? '';
          detailControllers[i]['palka_s_dobi']!.text =
              detail.palkaSDobi?.toString() ?? '';
          detailControllers[i]['palka_s_mni']!.text =
              detail.palkaSMni?.toString() ?? '';

          // detailControllers[i]['palka_c_no']!.text = detail.palkaCNo ?? '';
          detailControllers[i]['palka_c_ffa']!.text =
              detail.palkaCFfa?.toString() ?? '';
          detailControllers[i]['palka_c_iv']!.text =
              detail.palkaCIv?.toString() ?? '';
          detailControllers[i]['palka_c_dobi']!.text =
              detail.palkaCDobi?.toString() ?? '';
          detailControllers[i]['palka_c_mni']!.text =
              detail.palkaCMni?.toString() ?? '';

          // detailControllers[i]['palka_p_no']!.text = detail.palkaPNo ?? '';
          detailControllers[i]['palka_p_ffa']!.text =
              detail.palkaPFfa?.toString() ?? '';
          detailControllers[i]['palka_p_iv']!.text =
              detail.palkaPIv?.toString() ?? '';
          detailControllers[i]['palka_p_dobi']!.text =
              detail.palkaPDobi?.toString() ?? '';
          detailControllers[i]['palka_p_mni']!.text =
              detail.palkaPMni?.toString() ?? '';
        }
          ...
          child: Column(
            children: [
              ...
              CustomSectionCard('Detail Data', [
                if (detailControllers.isNotEmpty)
                  _detailFormList()
                else
                  Center(
                    child: Text(
