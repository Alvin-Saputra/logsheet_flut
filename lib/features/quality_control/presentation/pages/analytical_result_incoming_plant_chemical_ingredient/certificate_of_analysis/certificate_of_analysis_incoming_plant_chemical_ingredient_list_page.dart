...
import 'package:logsheet_app/features/quality_control/presentation/pages/analytical_result_incoming_plant_chemical_ingredient/certificate_of_analysis/certificate_of_analysis_incoming_plant_chemical_ingredient_detail_page.dart';
...
class CertificateOfAnalysisIncomingPlantChemicalIngredientListPage
    extends StatefulWidget {
  const CertificateOfAnalysisIncomingPlantChemicalIngredientListPage({
    super.key,
  });

  @override
  State<CertificateOfAnalysisIncomingPlantChemicalIngredientListPage>
  createState() =>
      _CertificateOfAnalysisIncomingPlantChemicalIngredientListPageState();
}

class _CertificateOfAnalysisIncomingPlantChemicalIngredientListPageState
    extends
        State<CertificateOfAnalysisIncomingPlantChemicalIngredientListPage> {
                    ...
                    return (provider.isLoading)
                        ...
                        : ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return _cardItem(
                              id: item.id ?? '',
                              date: item.tanggalPengiriman?.toString() ?? '',
                              entryBy: item.issueBy ?? '',
                              tank: item.product,
                              role: role,
                              vesselVehicle: item.vehicle,
                            );
                          },
                        );
                  },
