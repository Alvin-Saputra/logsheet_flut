...
class AnalyticalResultIncomingPlantChemicalIngredientApprovalListPage
    extends StatefulWidget {
  const AnalyticalResultIncomingPlantChemicalIngredientApprovalListPage({super.key});

  @override
  State<AnalyticalResultIncomingPlantChemicalIngredientApprovalListPage>
  createState() =>
      _AnalyticalResultIncomingPlantChemicalIngredientApprovalListPageState();
}

class _AnalyticalResultIncomingPlantChemicalIngredientApprovalListPageState
    extends State<AnalyticalResultIncomingPlantChemicalIngredientApprovalListPage> {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: Consumer<AnalyticalResultIncomingPlantChemicalIngredientProvider>(
              builder: (
