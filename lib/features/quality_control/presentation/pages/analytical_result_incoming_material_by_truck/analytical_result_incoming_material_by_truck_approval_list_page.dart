...
class AnalyticalResultIncomingMaterialByTruckApprovalListPage
    extends StatefulWidget {
  const AnalyticalResultIncomingMaterialByTruckApprovalListPage({super.key});

  @override
  State<AnalyticalResultIncomingMaterialByTruckApprovalListPage>
  createState() =>
      _AnalyticalResultIncomingMaterialByTruckApprovalListPageState();
}

class _AnalyticalResultIncomingMaterialByTruckApprovalListPageState
    extends State<AnalyticalResultIncomingMaterialByTruckApprovalListPage> {
    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Expanded(
            child: Consumer<AnalyticalResultIncomingMaterialByTruckProvider>(
              builder: (
  ...
  AppBar _buildAppBar() {
    formData =
        context
            ...
            .first;
    return AppBar(
      title: Text("Analytical Result Incoming Material By Truck Approval List (${formData!.code})"),
      actions: [
        ...
        onTap: () {
          Navigator.push(
            ...
            MaterialPageRoute(
              builder:
                  (context) =>
                      AnalyticalResultIncomingMaterialByTruckApprovalDetailPage(
                        data: context
                            .read<
                              AnalyticalResultIncomingMaterialByTruckProvider
                            >()
                            .reportList
