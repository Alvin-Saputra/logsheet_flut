...
_$AnalyticalResultIncomingMaterialByTruckDetailModelFromJson(
  ...
  jsonPFfa: json['p_ffa'] as String?,
  jsonPMoisture: json['p_moisture'] as String?,
  jsonPIv: json['p_iv'] as String?,
  jsonPDobi: json['p_dobi'] as String?,
  jsonPPv: json['p_pv'] as String?,
  jsonPColorR: json['p_color_r'] as String?,
  jsonPColorY: json['p_color_y'] as String?,
