...
_$AnalyticalResultIncomingMaterialByVesselDetailModelFromJson(
  ...
  jsonPalkaSNo: json['palka_s_no'] as String?,
  jsonPalkaSFfa: json['palka_s_ffa'] as num?,
  jsonPalkaSIv: json['palka_s_iv'] as num?,
  jsonPalkaSDobi: json['palka_s_dobi'] as num?,
  jsonPalkaSMni: json['palka_s_mni'] as num?,
  jsonPalkaCNo: json['palka_c_no'] as String?,
  jsonPalkaCFfa: json['palka_c_ffa'] as num?,
  jsonPalkaCIv: json['palka_c_iv'] as num?,
  jsonPalkaCDobi: json['palka_c_dobi'] as num?,
  jsonPalkaCMni: json['palka_c_mni'] as num?,
  jsonPalkaPNo: json['palka_p_no'] as String?,
  jsonPalkaPFfa: json['palka_p_ffa'] as num?,
  jsonPalkaPIv: json['palka_p_iv'] as num?,
  jsonPalkaPDobi: json['palka_p_dobi'] as num?,
  jsonPalkaPMni: json['palka_p_mni'] as num?,
);
