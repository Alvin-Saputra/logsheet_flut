...
part of 'analytical_result_outgoing_shipment_product_by_vessel_api_service.dart';
...
class _AnalyticalResultOutgoingShipmentProductByVesselApiService
    implements AnalyticalResultOutgoingShipmentProductByVesselApiService {
  ...
  insertReport(Map<String, dynamic> body, String token) async {
    ...
    late CreateAnalyticalResultOutgoingShipmentProductByVesselResponse _value;
    try {
      _value =
          CreateAnalyticalResultOutgoingShipmentProductByVesselResponse.fromJson(
            _result.data!,
          );
    } on Object catch (e, s) {
  ...
  fetchReports(String token, String? date) async {
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late FetchAnalyticalResultOutgoingShipmentProductByVesselResponse _value;
    try {
      _value =
