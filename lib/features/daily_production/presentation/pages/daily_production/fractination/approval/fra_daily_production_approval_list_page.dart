...
class _DailyProductionFractinationApprovalListPageState
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Fractionation Approval List"),
        actions: [
              ...
              child: ExpansionTile(
                ...
                children: [
                  ...sortedShiftKeys.map((shiftKey) {
                    List<DailyProductionFractionationEntity> itemsInThisShift =
                        shiftMap[shiftKey]!;
  ...
  void _showApprovedRejectedBottomSheet({
    ...
    required DailyProductionFractionationEntity headerData,
    required dynamic
