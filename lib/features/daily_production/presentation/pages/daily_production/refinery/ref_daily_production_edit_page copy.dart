...
//     setState(() {
//       final item = inputItems[index]; // simpan dulu

//       deletedIds.add(item.id!);
//       item.dispose(); // dispose controller
//       inputItems.removeAt(index); // baru hapus
//     });
//   }
...
//             item.selectedOilBp =
//                 entity.oilTypeBpId; // Override jika per-row bisa beda
...
//       bleachingBatchController.text = firstItem.beLotBatchNumber?.toString()??"";
...
//       phosphoricBatchController.text = firstItem.paLotBatchNumber?.toString()??"";
...
//                           onTankChanged:
//                               (value) => setState(() {
//                                 inputItems[i].selectedTankRm = value;
//                               }),
//                           // RM Controllers
...
//                               }),
//                               showCheckboxUseTankFromLastShiftChangedRm: false, selectedOil: '',
//                         ),
...
//     List<RefineryInputItem> newItems =
...
//         showSnackBar("Gagal generate Ticket ID baru.");
//         return;
//       }
//     }
...
//               // Phosphoric Acid - Mapped to Global State 1 Bag (1000 Kg)
...
//           plantCode,
//         );
//         showSnackBar('Berhasil Mengupdate Ticket.');
//         // if (!mounted) return;
//         Navigator.pop(context);
//       } else {
//         showSnackBar('Error Update.');
//       }
//     } catch (e) {
